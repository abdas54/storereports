sap.ui.define([
    ...
    function (Controller, Fragment, MessageBox, epson2) {
        "use strict";
        var that;
        return Controller.extend("com.eros.storereports.controller.DailyReport", {
            onInit: function () {
            ...
            fnSearch: function () {
                ...
                this._loadData(oFromDate, sStore);
            },
            _loadData: function (fromDate, store) {
                var oModel = this.getView().getModel();
                var aFilters = [];
                var that = this;
                if (store) {
                    aFilters.push(new sap.ui.model.Filter("Store", "EQ", store));
                }
