		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reports",
									"targetURL": "#comerosstorereports-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerosstorereports-display": {
								"semanticObject": "comerosstorereports",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.storereports",
									"url": sap.ui.require.toUrl("com/eros/storereports")
								}
							}
						}
					}
